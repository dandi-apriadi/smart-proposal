...
import routes from "../../routes/routes-bendahara.js";
import { getMe } from "store/slices/authSlice";
import { useDispatch, useSelector } from "react-redux";

export default function Bendahara(props) {
  const { ...rest } = props;
  ...
  useEffect(() => {
    ...
    const currentRoute = routes.find(
      (route) => route.layout === "/bendahara" && route.path === currentPath
    );
          ...
          <div className="h-full">
            ...
            <div className="pt-5 mx-auto mb-auto h-full min-h-[84vh] p-2 md:pr-2">
              <Routes>
                ...
                <Route
                  path="/"
                  element={<Navigate to="/bendahara/default" replace />}
                />
              </Routes>
            </div>
            <div className="p-3">
