...
const userData = {
    ...
    userGrowth: 12.4,
    userRoles: [
        { role: "Dosen", count: 680 },
        { role: "Reviewer", count: 241 },
        { role: "Admin", count: 32 },
        { role: "Wadir", count: 8 },
        { role: "Undefined", count: 15 }
    ],
    userActivity: [
        { month: "Jan", users: 820 },
        { month: "Feb", users: 850 },
        ...
        { month: "May", users: 950 },
        { month: "Jun", users: 980 },
        { month: "Jul", users: 1010 },
        { month: "Aug", users: 1040 },
        { month: "Sep", users: 1080 },
    ...
    departmentDistribution: [
        { department: "Teknik Elektro", users: 320 },
        { department: "Teknik Sipil", users: 290 },
        { department: "Teknik Informatika", users: 350 },
        { department: "Akuntansi", users: 178 },
        { department: "Administrasi Bisnis", users: 110 }
    ],
    userStatus: [
        { status: "Online", count: 287 },
        { status: "Away", count: 95 },
        { status: "Offline", count: 842 },
        { status: "Suspended", count: 24 }
    ]
};

// Add detailed insights data
const userInsightsData = {
    ...
    activity: {
        activeTimes: [
            { day: "Monday", timeRange: "10:00-12:00", activity: "High", progress: 8.2, previousValue: "Medium" },
            { day: "Wednesday", timeRange: "14:00-16:00", activity: "High", progress: 5.1, previousValue: "High" },
            { day: "Friday", timeRange: "09:00-11:00", activity: "High", progress: 12.4, previousValue: "Medium" },
            { day: "Tuesday", timeRange: "13:00-15:00", activity: "Medium", progress: -3.2, previousValue: "High" },
            { day: "Thursday", timeRange: "11:00-13:00", activity: "Medium", progress: 0, previousValue: "Medium" }
        ],
        mostUsedFeatures: [
            { feature: "Proposal Submission", usage: 84, progress: 7.2, previousUsage: 78 },
            { feature: "Review Management", usage: 72, progress: 5.9, previousUsage: 68 },
            { feature: "Profile Updates", usage: 61, progress: 2.3, previousUsage: 59 },
            { feature: "Document Uploads", usage: 57, progress: -1.8, previousUsage: 58 },
            { feature: "Feedback System", usage: 43, progress: 12.5, previousUsage: 38 }
        ],
        activityByDepartment: [
            { department: "Teknik Informatika", score: 87, progress: 5.8, previousScore: 82 },
            { department: "Teknik Elektro", score: 76, progress: 2.7, previousScore: 74 },
            { department: "Teknik Sipil", score: 72, progress: 4.3, previousScore: 69 },
            { department: "Akuntansi", score: 68, progress: -1.5, previousScore: 69 },
            { department: "Administrasi Bisnis", score: 61, progress: 3.4, previousScore: 59 }
        ],
        summary: "User activity metrics show consistent engagement with the platform. Peak usage occurs on Mondays, Wednesdays, and Fridays, with proposal submission remaining the most utilized feature across all departments."
    },
    engagement: {
        metrics: [
            {
        ...
        engagementByRole: [
            { role: "Dosen", score: 83, progress: 3.8, previousScore: 80 },
            { role: "Reviewer", score: 91, progress: 6.2, previousScore: 86 },
            { role: "Admin", score: 87, progress: 1.2, previousScore: 86 },
            { role: "Wadir", score: 76, progress: 8.6, previousScore: 70 }
        ],
        engagementTrends: [
            { month: "Jan", score: 72 },
            { month: "Feb", score: 74 },
    ...
    retention: {
        ...
        retentionByRole: [
            { role: "Dosen", rate: 94, progress: 1.1, previousRate: 93 },
            { role: "Reviewer", rate: 96, progress: 0.5, previousRate: 95.5 },
            { role: "Admin", rate: 98, progress: 0, previousRate: 98 },
            { role: "Wadir", rate: 100, progress: 0, previousRate: 100 }
        ],
        retentionByDepartment: [
            { department: "Teknik Informatika", rate: 95, progress: 2.3, previousRate: 93 },
            { department: "Teknik Elektro", rate: 93, progress: 1.1, previousRate: 92 },
            { department: "Teknik Sipil", rate: 92, progress: 0.7, previousRate: 91.3 },
            { department: "Akuntansi", rate: 91, progress: -0.5, previousRate: 91.5 },
            { department: "Administrasi Bisnis", rate: 90, progress: 1.4, previousRate: 88.6 }
        ],
        retentionTrends: [
            { quarter: "Q1 2024", rate: 89, newUsers: 120, retained: 107, churn: 13 },
            { quarter: "Q2 2024", rate: 90, newUsers: 145, retained: 131, churn: 14 },
            { quarter: "Q3 2024", rate: 91, newUsers: 178, retained: 162, churn: 16 },
            { quarter: "Q4 2024", rate: 92, newUsers: 210, retained: 193, churn: 17 },
            { quarter: "Q1 2025", rate: 92, newUsers: 187, retained: 172, churn: 15 }
        ],
